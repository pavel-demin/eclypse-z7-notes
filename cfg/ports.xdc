...
set_property PACKAGE_PIN AA22 [get_ports {dac_cfg_o[0]}]
set_property PACKAGE_PIN W15 [get_ports {dac_cfg_o[1]}]
set_property PACKAGE_PIN Y15 [get_ports {dac_cfg_o[2]}]
set_property PACKAGE_PIN Y13 [get_ports {dac_cfg_o[3]}]
