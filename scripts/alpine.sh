...
zip -r eclypse-z7-alpine-3.12-armv7-`date +%Y%m%d`.zip apps boot.bin cache devicetree.dtb modloop eclypse-z7.apkovl.tar.gz uEnv.txt uImage uInitrd wifi
